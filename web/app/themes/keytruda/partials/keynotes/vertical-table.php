...
?>
   ...
   <div class="main-row table-<?php echo $i?>">
    ...
    <?php if($table_rows) { ?>
     <div class="table-hold <?php if(!$title) echo ' empty-title';?>">
        ...
        <?php if($cols_count == 'one') { ?>
         ...
         <div class="tr">
          <?php foreach($one_col as $col) { ?>
           ...
           ?>
           <div class="one-col <?php if($custom_class) echo $custom_class;?> td <?php echo $col_bg;?>" <?php if($custom_color) echo ' style="color:'.$custom_color.'"';?>><div class="hold"><?php echo $col['text']?></div></div>
          <?php } ?>
         </div> 
         <?php } } ?>
            ...
            <div class="tr">
              <?php foreach($two_cols as $col) { ?>
               <?php 
                ...
                $custom_class = $col['custom_class'];
               ?>
               <div class="two-cols <?php if($custom_class) echo $custom_class;?> td <?php echo $col_bg;?>" <?php if($custom_color) echo ' style="color:'.$custom_color.'"';?>><div class="hold"><?php echo $col['text']?></div></div>
              <?php } ?>
            </div> 
          <?php } } ?>
          ...
          <div class="tr">
           <?php foreach($three_cols as $col) { ?>
            <?php 
              ...
              $custom_class = $col['custom_class'];
            ?>
            <div class="three-cols <?php if($custom_class) echo $custom_class;?> td  <?php echo $col_bg;?>" <?php if($custom_color) echo ' style="color:'.$custom_color.'"';?>><div class="hold"><?php echo $col['text']?></div></div>
           <?php } ?>
          </div> 
         <?php } } ?>
          ...
          <div class="tr">
           <?php foreach($four_cols as $col) { ?>
            <?php 
              ...
              $custom_class = $col['custom_class'];
            ?>
            <div class="four-cols <?php if($custom_class) echo $custom_class;?> td <?php echo $col_bg;?>" <?php if($custom_color) echo ' style="color:'.$custom_color.'"';?>><div class="hold"><?php echo $col['text']?></div></div>
           <?php } ?>
          </div> 
         <?php } } ?>
        <?php } ?> 
